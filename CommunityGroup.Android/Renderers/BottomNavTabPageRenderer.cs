...
using Android.Views;
using CommunityGroup.Droid.RenderersPage;
using CommunityGroup.Views.Tapped;
using Xamarin.Forms;
using Xamarin.Forms.Platform.Android.AppCompat;
using View = Android.Views.View;

[assembly: ExportRenderer(typeof(TappedPagePrincipal), typeof(BottomNavTabPageRenderer))]
namespace CommunityGroup.Droid.RenderersPage
{
