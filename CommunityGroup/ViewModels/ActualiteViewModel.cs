    ...
    public class ActualiteViewModel : BaseViewModel
    {
        ...
        public ActualiteViewModel()
        {
            ListActualite = new List<DtoActualite>()
            {
                new DtoActualite() {
                    ActualiteId = 2,
                    //CodeUnivers = AppEcpace.MEDICAL.ToString(),
                    ...
                    ImageActualite = "http://www.pewresearch.org/wp-content/uploads/sites/8/2016/07/PJ_2016.07.07_Modern-News-Consumer_0-01.png",
                ...
                new DtoActualite() {
                    ActualiteId = 1,
                    //CodeUnivers = AppEcpace.SOCIAL.ToString(),
                    ...
                    ImageActualite = "https://media.gettyimages.com/photos/orange-jellyfish-in-pink-aquarium-chicago-illinois-usa-picture-id973973124",
                    IsVue = false},
            };
        }
    }
